...
export class InserirCompromissoComponent implements OnInit{
  ...
  constructor(private formBuilder: FormBuilder, private compromissosService: CompromissosService, private contatosService: ContatosService,
  ...
  ngOnInit(): void {
    this.form = this.formBuilder.group({
      ...
      data: new FormControl('11/10/2023', [Validators.required]),
    ...
    this.contatosService.selecionarTodos().subscribe((contatos) => (this.contatos = contatos))
  }
